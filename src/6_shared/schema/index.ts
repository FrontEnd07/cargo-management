...
const ERROR_MESSAGES = {
    ...
    CURRENCY_MIN: "Выберите хотя бы одну валюту",
    CURRENCY_MAX: "Максимум 5 валют",
...
const currencies = z.array(selectOptionSchema)
    .min(VALIDATION_LIMITS.SYMBOL.MIN, ERROR_MESSAGES.CURRENCY_MIN)
    .max(VALIDATION_LIMITS.SYMBOL.MAX, ERROR_MESSAGES.CURRENCY_MAX)
