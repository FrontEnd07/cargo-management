...
interface CreateTagsProps {
    ...
    id?: string;
    errors?: string;
    value?: readonly Option[] | string[]; // Принимаем оба типа
    onChange?: (value: readonly Option[] | string[]) => void; // Возвращаем нужный тип
}
...
export const CreateTags = ({
    ...
    // Конвертируем входящие значения в нужный формат
    ...
    const handleKeyDown: KeyboardEventHandler = (event) => {
        ...
        switch (event.key) {
            ...
            case "Tab":
                ...
                if (!normalizedValue.some((option) => option.value === inputValue)) {
                    const newValues = [...normalizedValue, newValue];
                    onChange?.(newValues);
                }
                setInputValue("");
