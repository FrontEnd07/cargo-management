...
import type { MultiValue, SingleValue, ClassNamesConfig, GroupBase } from "react-select"
...
export const SelectAsync = ({
    ...
    const tegsClassNames: ClassNamesConfig<Option, true, GroupBase<Option>> = classNames<Option, true>(
        errors ? true : false
    );
    ...
    return (
        <div>
            ...
            <div>
                <AsyncSelect<Option, true, GroupBase<Option>>
                    // Основные пропсы
                    id={id}
                    isMulti={isMulti}
