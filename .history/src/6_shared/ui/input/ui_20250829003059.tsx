...
export const Input = memo(forwardRef<HTMLInputElement, InputProps>(({ errors, type, value, label, id, className, onClear, showError = true, placeholder, ...props }, ref) => {
    return (
        <div>
            {label &&
            ...
            <div className='relative'>
                <input
                    ...
                    ref={ref}
                    autoComplete="off"
                    className={`${clsx(className)} bg-white appearance-none relative block w-full px-3 py-2 border 
