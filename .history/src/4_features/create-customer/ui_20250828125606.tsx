...
export const CreateCustomer = () => {
    ...
    const {
        ...
        defaultValues: {
            ...
            name: "",
            address: "",
            codes: [], // Убедитесь, что это массив
            date: new Date(),
        }
    })
    ...
    const handlerForm = (data: addCustomerTypesSchema) => {
            ...
            <div className='col-span-full'>
                <Controller
                    ...
                    render={({ field: { onChange, value, ...field }, fieldState }) => {
                        // Конвертируем строковый массив в массив Option
                        ...
                        return (
                            <CreateTags
                                ...
                                value={options}
                                onChange={(newValue) => {
                                    // Конвертируем обратно в массив строк для формы
                                    const stringValues = Array.isArray(newValue)
                                        ? newValue.map(item => item.value)
                                        : [];
                                    onChange(stringValues);
                                }}
                                errors={fieldState.error?.message as string}
                                label="Коды клиента*"
                                id="codes"
                            />
                        );
