...
export const ItemRow = memo<ItemRowProps>(
    ({ item, index, onChange, onRemove, errors = {} }) => {
        ...
        const {
            ...
            handleProductRoutes,
            handleCurrency
        } = useItemRowHandlers(index, item, onChange);
                    ...
                    <div className="grid grid-cols-3 gap-3 items-end">
                        <div className="!py-1 !px-1">
                            <EditableCell
                                ...
                                field="length"
                                item={item}
                                onChange={handleInput("length")} // ✅ Теперь передаем готовый обработчик
                                errors={errors}
                                type="number"
                                step="0.01"
                            />
                        ...
                        <div className="!py-1 !px-1">
                            <EditableCell
                                ...
                                field="kgPerUnit"
                                item={item}
                                onChange={handleInput("kgPerUnit")}
                                errors={errors}
                                type="number"
                                step="0.01"
                            />
