...
import { TableClientRender, SelectAsync, DatePicker } from "6_shared/ui";
        ...
        <div className="grid grid-cols-4 gap-4 items-end mb-6">
            ...
            <div>
                <DatePicker
                    label="Период"
                    name={""}
                    onChange={function (value: { date: Date; dateStr: string; } | { start?: Date | undefined; end?: Date | undefined; dateStr: string; }): void {
