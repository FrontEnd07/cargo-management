...
const buildOrderBy = (sortBy?: string, sortOrder: "asc" | "desc" = "asc") => {
    ...
    // сортировка по связанному Document
    if (documentSortFields.includes(sortBy as DocumentSortField)) {
        return { document: { [sortBy]: sortOrder } };
    }
...
export const itemsRouter = router({
    ...
    getItemsProduct: protectedProcedure
        ...
        .query(async ({ input, ctx }) => {
            ...
            const orderBy = buildOrderBy(sortBy, sortOrder as "asc" | "desc");
